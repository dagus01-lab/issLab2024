...
public class ProduceAsObservableActorExternal extends ActorNaiveCaller{
	protected String msgId        = "distance";
	protected String  msgReceiver = "consumer";
	protected String pfx          = "        ";	  
	  

	public ProduceAsObservableActorExternal(String name, ProtocolType protocol, String hostAddr, String entry) {
...
//TERMINAZIONE DEL PRODUCER  			
    ...
    public static void main(String[] args ){
        new ProduceAsObservableActorExternal("prodexternal", ProtocolType.tcp, "localhost", MainOneNodeWithActorsAndObserver.entry) ;
    }	
