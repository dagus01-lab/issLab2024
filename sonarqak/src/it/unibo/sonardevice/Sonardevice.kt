		...
		return { //this:ActionBasciFsm
				...
				state("readSonarData") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t00",targetState="readSonarData",cond=whenDispatchGuarded("doread",{ working    
					}))
					transition(edgeName="t01",targetState="endOfRead",cond=whenDispatchGuarded("doread",{ ! working  
					}))
				}	 
